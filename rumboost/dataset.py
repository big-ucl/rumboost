...
def load_preprocess_LPMC():
    ...
    try:
        train_idx, test_idx = pickle.load(
            open("/home/nicolas-salvade/rumboost/Data/strat_group_k_fold_london.pickle", "rb")
        )
        ...
        pickle.dump(
            [train_idx, test_idx], open("/home/nicolas-salvade/rumboost/Data/strat_group_k_fold_london.pickle", "wb")
        )
